...
const pintaCards = data => {
    for (i=0; i<data.length; i++){
        ...
        //     pinta(data[i]);
        // };
        // if (data[i].nom_accessori == (rutinaValors.accessori) 
        // ){
        //     pinta(data[i]);
        // };
        // if (data[i].dni_entrenador == dniEntrenador 
        // ){
        //     pinta(data[i]);
        // };
        // if (data[i].nivell == nivellEscollit 
        // ){
        //     pinta(data[i]);
        // };
        // if (data[i].duracio == rutinaValors.duracio 
        // ){
        //     pinta(data[i]);
        // };
        rutinaControl = data[i];
        if (data[i].nom_modalitat == (rutinaValors.categoria) ||
