  ...
  <body>
    <header>
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <a class="navbar-brand" href="#">HOME TRAINING</a>
          ...
          <div class="carousel-item">
            ...
            <div class="container">
              <div class="carousel-caption">
                <h1>HOME TRAINING</h1>
                <p>ENTRENA DESDE CASA COMO SI ESTUVIESES EN EL GIMNASIO</p>
